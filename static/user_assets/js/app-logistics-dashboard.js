    ...
    var s = {
        ...
        r = {
            series: [{
                name: "Trips",
                type: "column",
                // create data of length 30
                data: [38, 45, 33, 38, 32, 50, 48, 40, 42, 37, 50, 48, 34, 12, 45, 50, 39, 56, 12, 87, 23, 67, 22, 65, 82, 39, 56, 12, 87, 23]
            }, {
                name: "Events",
                type: "line",
                // create data of same length as trips starting from 480 and slowly decreasing to 140. Values should random +-30% from its expected
                data: [479, 458, 460, 457, 433, 396, 419, 376, 385, 381, 355, 408, 371, 355, 329, 343, 345, 285, 339, 309, 273, 242, 233, 214, 258, 196, 249, 233, 223, 230]
        ...
        a = (null !== a && new ApexCharts(a, r).render(), document.querySelector("#deliveryExceptionsChart")),
        r = {
            chart: {
                height: 420,
                parentHeightOffset: 0,
